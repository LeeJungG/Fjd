...
<div id="main-div">
    <div id="menu-list">
        ...
        <?php foreach ($pr as $k => $v): ?>
            ...
            <?php echo ($v["pri_name"]); ?>
                <ul>
                <?php foreach ($v['che'] as $k2 => $v2): ?>
                    <li class="menu-item"><a href="<?php echo U($v2['module_name'].'/'.$v2['controller_name'].'/'.$v2['action_name']);?>" target="main-frame"><?php echo ($v2["pri_name"]); ?></a></li>
                  <?php endforeach; ?>
                </ul>
            </li>
      <?php endforeach; ?>
    ...
    Object.extend(
        ToggleHanlder ,{
            ...
            Load : function() {
                ...
                document.getElementById('toggleImg').src = collapse ? '/Public/Admin/Images/menu_minus.gif' : './Images/menu_plus.gif';
                document.getElementById('toggleImg').alt = collapse ? collapse_all : expand_all;
            }
        }
    );
