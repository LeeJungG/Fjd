...
<div class="main-div">
    <form name="main_form" method="POST" action="/index.php/Admin/MemberLevel/edit/level_id/1.html" enctype="multipart/form-data" >
    	<input type="hidden" name="level_id" value="<?php echo $data['level_id']; ?>" />
