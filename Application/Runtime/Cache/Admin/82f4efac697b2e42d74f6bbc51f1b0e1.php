    ...
    <form name="main_form" method="POST" action="/index.php/Admin/Admin/add.html" enctype="multipart/form-data">
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                ...
                <td>
                    <input  type="text" name="admin_password2" value="" />
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <?php if(is_array($role)): $i = 0; $__LIST__ = $role;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><input  type="checkbox" name="role_id[]" value="<?php echo ($v["role_id"]); ?>" /><?php echo ($v["role_name"]); endforeach; endif; else: echo "" ;endif; ?>
                </td>
            </tr>
            <tr>
