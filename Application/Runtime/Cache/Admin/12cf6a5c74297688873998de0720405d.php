	...
	<table cellpadding="3" cellspacing="1">
		...
		<?php foreach ($data as $k => $v): ?>            
			<tr class="tron">
				...
				<td><?php echo $v['ber']; ?></td>
		        <td align="center">
		        	<a href="<?php echo U('goods_number?goods_id='.$v['goods_id'].'&p='.I('get.p')); ?>" title="库存">库存</a> |
		        	<a href="<?php echo U('edit?goods_id='.$v['goods_id'].'&p='.I('get.p')); ?>" title="编辑">编辑</a> |
	                <a href="<?php echo U('recycle?goods_id='.$v['goods_id'].'&p='.I('get.p')); ?>" onclick="return confirm('确定要放入回收站吗？');" title="放入回收站">放入回收站</a> 
		        </td>
	        </tr>
        <?php endforeach; ?> 
