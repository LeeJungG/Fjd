<?php
return array(
	'tableName' => 'jd_goods',    // 表名
	'tableCnName' => '商品',  // 表的中文名
	'moduleName' => 'Admin',  // 代码生成到的模块
	'digui' => 0,             // 是否无限级（递归）
	'diguiName' => '',        // 递归时用来显示的字段的名字，如cat_name（分类名称）
	'pk' => 'goods_id',    // 表中主键字段名称
	/********************* 要生成的模型文件中的代码 ******************************/
	'insertFields' => "array('goods_name','cat_id','brand_id','market_price','jd_price','jifen','jyz','jifen_price','is_promote','promote_price','promote_start_time','promote_end_time','is_hot','is_new','is_best','is_on_sale','seo_keyword','seo_description','type_id','sort_num','is_delete','goods_desc')",
	'updateFields' => "array('goods_id','goods_name','cat_id','brand_id','market_price','jd_price','jifen','jyz','jifen_price','is_promote','promote_price','promote_start_time','promote_end_time','is_hot','is_new','is_best','is_on_sale','seo_keyword','seo_description','type_id','sort_num','is_delete','goods_desc')",
	'validate' => "
	...
	'search' => array(
		...
		array('jd_price', 'between', 'jd_pricefrom,jd_priceto', '', '本店价'),
		array('is_hot', 'normal', '', 'eq', '是否热卖'),
		array('is_new', 'normal', '', 'eq', '是否新品'),
		array('is_best', 'normal', '', 'eq', '是否精品'),
